package u.awsmizng.awsm.androidarduinoconnect;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etSendText = (EditText) findViewById(R.id.etText);
            ...
            public void onClick(View v) {
                ...
                if (mmSocket != null) {
                    if (mmSocket.isConnected() && btt != null) {
                        //if we have connection to the bluetooth module
                        if (!lightflag) {
                            String sendtxt = "LY";
...
//                            relayFlag = true;
//                        }
                        String sendtxt = etSendText.getText().toString().trim();
                        btt.write(sendtxt.getBytes());
